...
image = Image.open('F:\projects\BiomedParse-main\examples\Part_1_516_pathology_breast.png', formats=['png'])
...
for prompt in prompts:
    gt_mask = Image.open(f"F:\projects\BiomedParse-main\examples\Part_1_516_pathology_breast_{prompt.replace(' ', '+')}.png", formats=['png'])
